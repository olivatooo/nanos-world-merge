...
ShopItems = {
    -- HATS/ACCESSORIES
    {
        ...
        apply = function(character)
            ...
            hat:SetMaterialColorParameter("Tint", Color.Random())
    ...
    },
    {
        ...
        category = "color",
        apply = function(character)
            character:SetMaterialColorParameter("Tint", Color(0.2, 0.4, 1000))
        end
    },
    {
        id = "color_green",
        ...
        category = "color",
        apply = function(character)
            character:SetMaterialColorParameter("Tint", Color(0.2, 10000, 0.3))
        end
    },
    {
        id = "color_purple",
    ...
    },
    {
        ...
        category = "color",
        apply = function(character)
            character:SetMaterialColorParameter("Tint", Color(1000, 840, 0))
            character:SetMaterialColorParameter("Emissive", Color(10, 8.4, 0))
            character:SetMaterialScalarParameter("Metallic", 10)
        end
    },
    {
        id = "color_rainbow",
        ...
        apply = function(character)
            ...
            Timer.SetInterval(function()
                if character:IsValid() then
                    time = time + 0.05
                    local r = ((math.sin(time) + 1) / 2) * 10
                    local g = ((math.sin(time + 2.094) + 1) / 2) * 10
                    local b = ((math.sin(time + 4.189) + 1) / 2) * 10
    ...
    },
    {
        ...
        category = "color",
        apply = function(character)
            character:SetMaterialColorParameter("Emissive", Color(0.5, 1, 1) * 10)
            character:SetMaterialColorParameter("Tint", Color(0.3, 0.8, 1) * 10)
        end
    },
    {
        id = "color_shadow",
        ...
        category = "color",
        apply = function(character)
            character:SetMaterialColorParameter("Tint", Color(0, 0, 0))
            character:SetMaterialColorParameter("Emissive", Color(0, 0, 0))
        end
    },
    ...
    },
    {
        ...
        category = "effect",
        apply = function(character)
            character:SetScale(Vector(2.0, 2.0, 2.0))
        end
    },
}
